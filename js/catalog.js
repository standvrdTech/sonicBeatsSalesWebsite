...
const CATALOG = [
  {
    ...
    colors: [
      { name: 'Forest Green', hex: '#3d6e4a', img: 'assets/slides/enigma_green.webp' },
      { name: 'Ocean Blue',   hex: '#2a4f7a', img: 'assets/slides/enigma_blue.webp' },
      { name: 'Slate Grey',   hex: '#8a8e96', img: 'assets/slides/enigma_grey.webp' },
      { name: 'Dusty Pink',   hex: '#c97488', img: 'assets/slides/enigma_pink.webp' },
    ],
    inCollection: true,
    inCompare: true,
  },
  ...
  },
  {
    ...
    colors: [
      { name: 'Forest Green', hex: '#3d6e4a', img: 'assets/slides/tinymen_green.webp' },
      { name: 'Ocean Blue',   hex: '#2a4f7a', img: 'assets/slides/tinymen_blue.webp' },
      { name: 'Slate Grey',   hex: '#8a8e96', img: 'assets/slides/tinymen_grey.webp' },
      { name: 'Dusty Pink',   hex: '#c97488', img: 'assets/slides/tinymen_pink.webp' },
    ],
    inCollection: true,
    inCompare: true,
  },
  {
    ...
    colors: [
      { name: 'Forest Green', hex: '#3d6e4a', img: 'assets/slides/blackbox_green.webp' },
      { name: 'Ocean Blue',   hex: '#2a4f7a', img: 'assets/slides/blackbox_blue.webp' },
      { name: 'Slate Grey',   hex: '#8a8e96', img: 'assets/slides/blackbox_grey.webp' },
      { name: 'Dusty Pink',   hex: '#c97488', img: 'assets/slides/blackbox_pink.webp' },
    ],
    inCollection: true,
    inCompare: true,
  },
